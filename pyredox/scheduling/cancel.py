...
CancelVisitAdditionalStaffLocation.update_forward_refs()
...
CancelVisitConsultingProviderLocation.update_forward_refs()
...
CancelVisitVisitProviderLocation.update_forward_refs()
